            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center bg-gray-50 px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label htmlFor="name" className="block text-xs font-semibold text-gray-500 tracking-widest mb-1">TU NOMBRE</label>
                            <input id="name" type="text" placeholder="María González" value={name} required
                        ...
                        <div>
                            <label htmlFor="storeName" className="block text-xs font-semibold text-gray-500 tracking-widest mb-1">NOMBRE DE TU TIENDA</label>
                            <input id="storeName" type="text" placeholder="Boutique María" value={storeName} required
                        ...
                        <div>
                            ...
                            <input id="password" type="password" placeholder="Mínimo 6 caracteres" value={password} required
                        ...
                        <button
                            ...
                            className="w-full py-3 px-4 rounded-xl font-semibold text-white bg-green-500 hover:bg-green-600 transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-2"
                        >
